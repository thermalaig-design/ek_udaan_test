...
// Parse plain-text numbered sections like "1. Title Content" into structured sections
      ...
      <div style={s.body}>
        {loading && (
          <div style={{ padding: '24px' }}>
            <SkeletonLine width="60%" height="18px" mb="20px" />
            {[1,2,3,4,5].map(i => (
              <div key={i} style={{ marginBottom: '28px' }}>
                <SkeletonLine width="40%" height="15px" mb="10px" />
                <SkeletonLine width="100%" mb="6px" />
                <SkeletonLine width="95%" mb="6px" />
                <SkeletonLine width="88%" mb="0" />
              </div>
            ))}
          </div>
        )}
        ...
        {!loading && !error && !content && (
          <div style={s.emptyBox}>
            ...
            <p style={{ color: '#64748b', fontSize: '15px', margin: 0 }}>Terms & Conditions not available yet.</p>
          </div>
        )}
...
const s = {
  ...
  introCard: {
    ...
    background: 'linear-gradient(135deg, #fff5f5 0%, #f0f1fb 100%)',
    border: `1px solid rgba(192,36,26,0.15)`,
    borderRadius: '16px',
    padding: '16px',
    marginBottom: '20px',
  },
